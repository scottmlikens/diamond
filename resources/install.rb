...
attribute :git_repository_uri, :kind_of => String, :default => "https://github.com/python-diamond/Diamond.git"
attribute :git_reference, :kind_of => String, :default => "master"
attribute :required_python_packages, :kind_of => Hash, :default => { "configobj" => "4.7.2","psutil" => "1.2.1"}
attribute :cookbook, :kind_of => String, :default => "diamond"
attribute :tarball_path, :kind_of => String, :default => "https://github.com/python-diamond/Diamond/archive/master.tar.gz"
